...
integration:
	ARTIE_INTEGRATION=1 go test -tags=integration -count=1 -timeout 180s ./internal/source/... ./internal/destination/... ./cmd/destination-writer/...

integration-verbose:
	ARTIE_INTEGRATION=1 go test -tags=integration -count=1 -timeout 180s -v ./internal/source/... ./internal/destination/... ./cmd/destination-writer/...
